...
# Important
Last version of this plugin (v0.0.9-SNAPSHOT) supports Jenkins version 2.164 or newer. Check previous [release versions](https://github.com/BBVA/mirrorgate-jenkins-builds-collector/releases) for Jenkins older versions.
